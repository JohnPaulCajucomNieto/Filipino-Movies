...
<body>
     <form class="form_container" method="POST" action="../PHP/login.php">
        ...
        <div class="input_container">
          <label class="input_label" for="email_field" name="email_field" >Email</label>
          ...
          <input placeholder="diaries@gmail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field">
        </div>
        <div class="input_container">
          <label class="input_label" for="password_field" name="password_field" >Password</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
